    ...
    (e.Widget.prototype = {
      ...
      _on: function (t, n) {
        var r,
          i = this;
        n
          ? ((t = r = e(t)), (this.bindings = this.bindings.add(t)))
          : ((n = t), (t = this.element), (r = this.widget())),
    ...
    e.uiBackCompat !== !1 &&
      ...
      e.widget("ui.tabs", e.ui.tabs, {
        ...
        _trigger: function (e, t, n) {
          ...
          return r
            ? (e === "beforeActivate" && n.newTab.length
  ...
  e.widget("ui.tooltip", {
    ...
    open: function (t) {
      ...
      if (this.options.track && r.data("ui-tooltip-id")) {
        this._find(r).position(e.extend({ of: r }, this.options.position)),
      ...
      r.attr("title") && r.data("ui-tooltip-title", r.attr("title")),
        ...
        t &&
          ...
          r.parents().each(function () {
            var t;
            e(this).data("tooltip-open") &&
              ((t = e.Event("blur")),
              (t.target = t.currentTarget = this),
              n.close(t, !0)),
              this.title &&
                (e(this).uniqueId(),
                (n.parents[this.id] = { element: this, title: this.title }),
                (this.title = ""));
          }),
    ...
    _open: function (t, r, i) {
      ...
      r.is("[title]") &&
        ...
        n(r, s.attr("id")),
        s.find(".ui-tooltip-content").html(i),
        this.options.track && t && /^mouse/.test(t.originalEvent.type)
    ...
    close: function (t) {
      ...
      i.data("ui-tooltip-title") && i.attr("title", i.data("ui-tooltip-title")),
        ...
        t &&
          t.type === "mouseleave" &&
          e.each(this.parents, function (e, t) {
...
(function (e, t) {
  (e.effects.effect.puff = function (t, n) {
    var r = e(this),
      ...
      u = o / 100,
      a = { height: r.height(), width: r.width() };
    e.extend(t, {
      effect: "scale",
      queue: !1,
      fade: !0,
    ...
    (e.effects.effect.scale = function (t, n) {
      ...
      (i.effect = "size"),
        ...
        (i.from = t.from || (s === "show" ? { height: 0, width: 0 } : f)),
        (i.to = {
          height: f.height * l.y,
          width: f.width * l.x,
      ...
      if (v === "content" || v === "both")
        (c = c.concat(["marginTop", "marginBottom"]).concat(l)),
          ...
          o.find("*[width]").each(function () {
            var n = e(this),
              r = { height: n.height(), width: n.width() };
            d && e.effects.save(n, f),
              (n.from = {
                height: r.height * s.from.y,
                width: r.width * s.from.x,
              }),
              (n.to = { height: r.height * s.to.y, width: r.width * s.to.x }),
              s.from.y !== s.to.y &&
